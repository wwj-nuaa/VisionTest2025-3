...
struct Buffer {
    ...
    Buffer(Buffer&& other) noexcept
        : data(std::exchange(other.data,nullptr)/* _____ */),
          size(std::exchange(other.size,0)/* _____ */)
    {}
    // ===== 结束 =====
};
// ===== 填空 3 结束 =====
